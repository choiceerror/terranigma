...
void ClockFadeOut::update()
{
	...
	if (_isClockFadeOut)
	{
		...
		if (2.4 + _clockWorldTime < TIMEMANAGER->getWorldTime())
		{
			_isClockFadeOut = false;
		}
	...
	{
		_clockMagentaAngle[0] = _clockBlackAngle[0] = (PI / 180) * 90;
		_clockMagentaAngle[1] = _clockBlackAngle[1] = (PI / 180) * 360;
		_clockMagentaAngle[2] = _clockBlackAngle[2] = (PI / 180) * 270;
		_clockMagentaAngle[3] = _clockBlackAngle[3] = (PI / 180) * 180;
